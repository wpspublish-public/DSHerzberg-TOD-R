...
tests <- c("erlne", "esege", "lske", "lswe", "rhye", "snwe")
...
all_lookups <- bind_rows(age_lookups,
  ...
  mutate(
    equiv = case_when(
      norm_group == "age" & test == "snwe"  & between(raw, 0, 7) ~ "< start age",
      norm_group == "age" & test == "snwe"  & between(raw, 8, 10) ~ "5:0 to 5:3",
      norm_group == "age" & test == "snwe"  & between(raw, 11, 12) ~ "5:4 to 5:7",
      norm_group == "age" & test == "snwe"  & between(raw, 13, 13) ~ "5:8 to 5:11",
      norm_group == "age" & test == "snwe"  & between(raw, 14, 15) ~ "6:0 to 6:5",
      norm_group == "age" & test == "snwe"  & between(raw, 16, 18) ~ "6:6 to 6:11",
      norm_group == "age" & test == "snwe"  & between(raw, 19, 20) ~ "7:0 to 7:5",
      norm_group == "age" & test == "snwe"  & between(raw, 21, 22) ~ "7:6 to 7:11",
      norm_group == "age" & test == "snwe"  & between(raw, 23, 24) ~ "8:0 to 8:5",
      norm_group == "age" & test == "snwe"  & between(raw, 25, 26) ~ "8:6 to 9:3",
      norm_group == "age" & test == "snwe"  & between(raw, 27, 32) ~ "> stop age",
      ...
      norm_group == "grade" & test == "snwe"  & between(raw, 0, 8) ~ "< start grade",
      norm_group == "grade" & test == "snwe"  & between(raw, 9, 12) ~ "K-Fall",
      norm_group == "grade" & test == "snwe"  & between(raw, 13, 14) ~ "K-Spring",
      norm_group == "grade" & test == "snwe"  & between(raw, 15, 17) ~ "1-Fall",
      norm_group == "grade" & test == "snwe"  & between(raw, 18, 20) ~ "1-Spring",
      norm_group == "grade" & test == "snwe"  & between(raw, 21, 22) ~ "2-Fall",
      norm_group == "grade" & test == "snwe"  & between(raw, 23, 25) ~ "2-Spring",
      norm_group == "grade" & test == "snwe"  & between(raw, 26, 32) ~ "> stop grade",
      ...
      norm_group == "grade" & test == "erlne"  & between(raw, 0, 7) ~ "< start grade",
      norm_group == "grade" & test == "erlne"  & between(raw, 8, 10) ~ "K-Fall",
      norm_group == "grade" & test == "erlne"  & between(raw, 11, 12) ~ "K-Spring",
      norm_group == "grade" & test == "erlne"  & between(raw, 13, 13) ~ "1-Fall",
      norm_group == "grade" & test == "erlne"  & between(raw, 14, 15) ~ "1-Spring",
      norm_group == "grade" & test == "erlne"  & between(raw, 16, 18) ~ "2-Fall",
      norm_group == "grade" & test == "erlne"  & between(raw, 19, 20) ~ "2-Spring",
      norm_group == "grade" & test == "erlne"  & between(raw, 27, 32) ~ "> stop grade",
      norm_group == "grade" & test == "lswe"  & between(raw, 0, 7) ~ "< start grade",
      norm_group == "grade" & test == "lswe"  & between(raw, 8, 10) ~ "K-Fall",
      norm_group == "grade" & test == "lswe"  & between(raw, 11, 12) ~ "K-Spring",
      norm_group == "grade" & test == "lswe"  & between(raw, 13, 13) ~ "1-Fall",
      norm_group == "grade" & test == "lswe"  & between(raw, 14, 15) ~ "1-Spring",
      norm_group == "grade" & test == "lswe"  & between(raw, 16, 18) ~ "2-Fall",
      norm_group == "grade" & test == "lswe"  & between(raw, 19, 20) ~ "2-Spring",
      norm_group == "grade" & test == "lswe"  & between(raw, 27, 32) ~ "> stop grade",
      norm_group == "grade" & test == "esege"  & between(raw, 0, 7) ~ "< start grade",
      norm_group == "grade" & test == "esege"  & between(raw, 8, 10) ~ "K-Fall",
      norm_group == "grade" & test == "esege"  & between(raw, 11, 12) ~ "K-Spring",
      norm_group == "grade" & test == "esege"  & between(raw, 13, 13) ~ "1-Fall",
      norm_group == "grade" & test == "esege"  & between(raw, 14, 15) ~ "1-Spring",
      norm_group == "grade" & test == "esege"  & between(raw, 16, 18) ~ "2-Fall",
      norm_group == "grade" & test == "esege"  & between(raw, 19, 20) ~ "2-Spring",
      norm_group == "grade" & test == "esege"  & between(raw, 27, 32) ~ "> stop grade",
      norm_group == "grade" & test == "lske"  & between(raw, 0, 7) ~ "< start grade",
      norm_group == "grade" & test == "lske"  & between(raw, 8, 10) ~ "K-Fall",
      norm_group == "grade" & test == "lske"  & between(raw, 11, 12) ~ "K-Spring",
      norm_group == "grade" & test == "lske"  & between(raw, 13, 13) ~ "1-Fall",
      norm_group == "grade" & test == "lske"  & between(raw, 14, 15) ~ "1-Spring",
      norm_group == "grade" & test == "lske"  & between(raw, 16, 18) ~ "2-Fall",
      norm_group == "grade" & test == "lske"  & between(raw, 19, 20) ~ "2-Spring",
      norm_group == "grade" & test == "lske"  & between(raw, 27, 32) ~ "> stop grade",
      TRUE ~ NA_character_
    ), 
