...
# the top level being a list for each test, and the lower level being the list
...
# Using map(), we subset as_tn_dfs 9 times, mapping accross the 9 elements of
...
# the names of their corresponding age_strats, usign set_names. Naming the list
