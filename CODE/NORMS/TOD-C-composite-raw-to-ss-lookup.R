...
input_file_path  <- "INPUT-FILES/NORMS/TODC_FINAL_composites/"
input_file_name <- "TODC_Adult_composites.csv"
input_file_stem <- "TODC_Adult_composites"
output_file_path  <- "OUTPUT-FILES/NORMS/TODC_FINAL_composites/"

score_names <- c("DDIQ", "LP", "RSQ", "SWA", "PHK", "BRS", 
                 "DE",  "SP",  "RFQ", "RCQ2", "PHA", 
                 "RAN", "AWM", "OP", "VC", "RN", "VCRN2", "VCRN4")
norm_type <- "_adult"
all_raw_range <- 80:1040
raw_range_per_score <- list(320:1040, 160:520, 160:520,  
                            80:260, 80:260, 80:260, 80:260,  
                            80:260, 80:260, 80:260, 120:390, 80:260, 
                            80:260, 80:260, 80:260, 80:260, 80:260, 160:520)
ss_lower_bound <- 40
ss_upper_bound <- 130
