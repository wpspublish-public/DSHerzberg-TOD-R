...
input_file_path  <- "INPUT-FILES/NORMS/TODC_Child_RFsumsofscores/"
input_file_name <- "TODC_Child_RFsumsofscores.csv"
input_file_stem <- "TODC_Child_RFsumsofscores"
output_file_path  <- "OUTPUT-FILES/NORMS/TODC_Child_RFsumsofscores/"

score_names <- c("RFW_combo", "RFQ_combo")
norm_type <- ""
