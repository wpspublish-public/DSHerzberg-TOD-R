...
ungroup(): inorder to process the input table here, the previous grouping by agestrat must be removed
selec(): this op will process only the agestrat and gender columns
count(): appends a new column `n` that has a count of males and females within each agestrat
